...
class Report extends React.Component {
  ...
  handleInput = e => {
    ...
    if(name in this.state.phanUngCoHaiADR ){
      this.setState({
        phanUngCoHaiADR: { ...this.state.phanUngCoHaiADR, [name]: value }
      });
    }
    if(name in this.state.thamdinhADR ){
      this.setState({
        thamdinhADR: { ...this.state.thamdinhADR, [name]: value }
      });
    }
    if(name in this.state.thongTinNguoiThamDinh ){
      this.setState({
  ...
  updateModal1 = () => {
    this.setState({
      thuocNghiNgoADR: [...this.state.thuocNghiNgoADR, this.state.thuocNghiNgoADRModalState]
    })
    this.setState({ visibleModal1: false });
  }
  ...
  updateModal2 = () => {
    this.setState({
      thuocDungDongThoiADR: [...this.state.thuocDungDongThoiADR, this.state.thuocDungDongThoiADRModalState]
    })
    this.setState({ visibleModal2: false });
  }
